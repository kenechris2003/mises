...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-md p-4 border-b-2 sticky top-0 z-50">
      <div className="container mx-auto flex pr-7 justify-between items-center">
        <Image
          src="/logo.png"
          alt="Logo"
          loading="eager"
        ...
        <div className="lg:hidden relative">
          ...
          >
                <Image src={"/menu.png"} alt="menu" width={24} height={24} className="mt-2 ml-20 " />
          </button>
          <div className="">
          {menuDropdown && (
            <ul className="grid space-x-6 lg:space-x-12">
            <li>
              <Link
                href="https://www.mises.site/static/file/whitepaper.pdf"
                className="text-black hover:text-gray-700"
